...
/**
 * Servlet implementation class Htcategory
 */
@WebServlet("/Htcategory")
public class Htcategory extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			ArrayList<productbean> dsproduct = pbo.getproduct();
			  if(ml!=null) dsproduct= pbo.TimMaLoai(ml);
			  else if(key!=null) dsproduct=pbo.Tim(key);
