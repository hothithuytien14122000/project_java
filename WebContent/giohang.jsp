...
<div class="container">
	...
	<%} %> 
	 ...
	 <li class="nav-item">
	    <a class="nav-link" href="contact.php">Chi tiết hóa đơn</a>
	</li>
	...
	<div class="row">
		...
		<label> GIỎ HÀNG CỦA BẠN </label> 
			...
			<% if(session.getAttribute("gh")!=null)
		       ...
		       <form action="editgiohang" method="get">  
           <tr>
			...
			<td>
				...
				<input type="submit" name="btnxoa" value="Xóa">
			 	<input type="hidden" name="title" value="<%=g.getId_product()%>">	
	 ...
	 <label> Tổng Tiền: <%= (format.format(gh1.TongTien() ))%> VNĐ</label> <hr style="margin-top:-2px"><br>
